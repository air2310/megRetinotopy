...
opt = getOpts('verbose',true);

if strcmp(subjID, 'wlsubj068')
    opt = getOpts('verbose',true, 'betaPrctileThresh', [0 94]); % default threshold of 95th percentile still gives very large/outlier beta values
end
