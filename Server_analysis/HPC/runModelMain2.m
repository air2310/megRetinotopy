...
opt = getOpts('verbose',true, 'perturbOrigPRFs','size');

if strcmp(subjID, 'wlsubj068')
    opt = getOpts('verbose',true, 'perturbOrigPRFs','size', 'betaPrctileThresh', [0 94]); % default threshold of 95th percentile still gives very large/outlier beta values
end
