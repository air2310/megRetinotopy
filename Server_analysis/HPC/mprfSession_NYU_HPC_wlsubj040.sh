...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/megRetinotopy/')); addpath(genpath('/scratch/ek99/megRetData/')); addpath(genpath('/scratch/ek99/vistasoft')); run('/scratch/ek99/megRetinotopy/Server_analysis/HPC/runModel$SLURM_ARRAY_TASK_ID.m'); exit()"
