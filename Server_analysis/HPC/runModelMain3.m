...
opt = getOpts('verbose',true, 'perturbOrigPRFs','position');

if strcmp(subjID, 'wlsubj068')
    opt = getOpts('verbose',true, 'perturbOrigPRFs','position', 'betaPrctileThresh', [0 94]); % default threshold of 95th percentile still gives very large/outlier beta values
end
