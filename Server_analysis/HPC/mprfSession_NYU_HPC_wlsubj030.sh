...
# you want to run.
matlab -nodisplay -r "addpath(genpath('/scratch/ek99/megRetinotopy/')); addpath(genpath('/scratch/ek99/megRetData/')); addpath(genpath('/scratch/ek99/vistasoft')); addpath('/scratch/ek99/fieldtrip'); ft_defaults; cd('/scratch/ek99/megRetData/wlsubj030'); run('runModel$SLURM_ARRAY_TASK_ID.m'); exit()"
