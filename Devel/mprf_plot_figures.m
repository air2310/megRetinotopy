...
try
    ...
    if ~exist('plot_type','var') || isempty(plot_type)
        ...
        fprintf('2 -  scrambled; channels for averaging  - all the channels on the back on head \n')
        ...
        fprintf('5 -  range; channels for averaging  - all the channels in the back of head \n')
