...
serverFolder  = '/Volumes/server/Projects/MEG/Retinotopy/Data';
...
% mrVNif_prf_data = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/prf_data/nifti',subject);
% rm_stim_file = fprintf('/mnt/storage_2/MEG/Retinotopy/Subject_sessions/%s/source/mrvista/rm_stimulus/rm_stim.mat',subject);
% prf_mat = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/prf_data/data_dir',subject);
% 
...
% Get volume view:
hvol = initHiddenGray;
% vANATOMYPATH = fprintf('/mnt/storage_2/MEG/Retinotopy/Data/fMRI/%s/3DAnatomy/t1.nii.gz',subject);

% Set the volume view to the current data type and add the RM model
hvol = viewSet(hvol,'curdt',vistaDataType);
hvol = rmSelect(hvol,1,vistaRetModel);
...
%% 2. Smoothed parameters (x,y,sigma, beta) on cortical surface 
...
FS_surface = fprintf('/mnt/storage_2/MEG/Retinotopy/Data/Freesurfer_directory/%s/surf',subject);
fs_prf_data = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/prf_data/surface/freesurfer',subject);
...
% Both hemisphere:
hs = {'LEFT','RIGHT'};
roi_dir = fprintf('/mnt/storage_2/MEG/Retinotopy/Data/fMRI/%s/Gray/ROIs',subject);
fs_roi_dir = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/rois/surface/freesurfer',subject);
bs_roi_dir = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/rois/surface/brainstorm',subject);
...
bs_model_path = fprintf('/mnt/storage_2/MEG/Retinotopy/Data/Brainstorm_db/data/%s/R0774_RETMEG_Block1_5.12.17/',subject); 
bs_anat_path = fprintf('/mnt/storage_2/MEG/Retinotopy/Data/Brainstorm_db/anat/%s/',subject);

bs_model_file = strcat(bs_model_path,'headmodel_surf_os_meg.mat');
bs_anat_file = strcat(bs_anat_path,'subjectimage_T1.mat');

bs_prf_data = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/prf_data/surface/brainstorm',subject);
bs_roi_dir = fprintf('/mnt/storage_2/MEG/Retinotopy/Quality_check/%s/rois/surface/brainstorm',subject);
