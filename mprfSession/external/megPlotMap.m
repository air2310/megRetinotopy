...
if notDefined('clims'),    clims = [min(sensor_data), max(sensor_data)];    end  % color map limits
...
opt = {'interpmethod','v4', ... How to interpolate the data?
        ...
        'shading','flat', ... How to interpolate in the outline
        'mask', cfg.layout.mask,...'style', 'imsatiso', ...
        'datmask', [], ...
        'clim', clims, ...
        'height', 1, ...
        'box','no',...
