function makeFigure3AverageSubject(opt, sensorsToAverage, summaryMetric)
...
if opt.saveFig
    ...
    print(fH1, fullfile(saveDir, sprintf('fig3a_AVERAGE_varyPositionSummary%s_%s_%s', opt.fNamePostFix, sensorsToAverage, summaryMetric)), '-dpng');
end
