...
if r==3 & c==3
  ...
  h1=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style,'color',prop.color);hold on
  [y,z,x] = getpoints(Cyz,prop.clip);
  h2=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style,'color',prop.color);hold on
  [z,x,y] = getpoints(Czx,prop.clip);
  h3=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style,'color',prop.color);hold on
