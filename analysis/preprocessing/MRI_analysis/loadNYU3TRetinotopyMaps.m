function prfDataPath = loadNYU3TRetinotopyMaps(subjID, dirPth, opt)
% Function to get pRF data from NYU 3T retinotopy dataset
% by Himmelberg, Kurzawski, Benson, Pelli, Carrasco, Winawer (2021)
% Cross-dataset reproducibility of population receptive field estimates and
% cortical magnification asymmetries. BiorXiv doi: 10.1101/2021.04.439348.
%
% This script relies on steps subject having average subject data
% interpolated to subject's FreeSurfer surface. See NYU3tave_to_sub.py
%
...
saveDir  = fullfile(dirPth.fmri.saveDataPth,'NYU3TAveRetinotopyPred');
...
if ~exist(fullfile(prfDataPath,'pial.x'))
    ...
    hemis = {'lh','rh'};
    prfParamNames = {'varexplained', 'x', 'y', 'sigma', 'eccentricity','polar_angle','beta'};
