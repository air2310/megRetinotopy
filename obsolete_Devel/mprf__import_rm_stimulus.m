function mprf__import_stimulus(w_stim)
...
switch lower(w_stim)
    ...
    case 'meg_stim'
        if mprfSESSION.has.meg_stim
            ...
            grid_idx = find(cell2mat(cellfun(@(x) strfind(x,'grid'), lower(fnames),...
            ...
            if isempty(grid_idx)
                ...
                if strcmpi(answer,'yes')
                    yes_to_all = false;
                    [yes_to_all, succes] = mprf__import_data(fullfile(gpath, gname),'meg_grid','MEG_grid.mat',yes_to_all);
            ...
            fpath = fullfile(mprf__get_directory('main_dir'), ...
                mprf__get_directory('meg_imported_stim'),'meg_stimulus.mat');
